        ...
        <div className="min-h-screen bg-white flex items-center justify-center p-4 font-sans">
            <div className="bg-[#eeeeee] w-full max-w-md rounded-[40px] p-10 shadow-xl relative">
                ...
                <form className="space-y-6" onSubmit={actionLogin}>
                    ...
                    <button type="submit" className="w-full bg-[#0047ff] hover:bg-blue-700 text-white font-bold py-4 rounded-2xl shadow-lg shadow-blue-500/30 transition-all active:scale-[0.98] text-xl mt-4">
                        Entrar
                    </button>
                </form>
